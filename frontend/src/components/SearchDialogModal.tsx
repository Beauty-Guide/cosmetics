...
const SearchDialogModal = ({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="w-2/3 max-md:w-full max-w-none sm:max-w-full flex flex-col justify-start items-start top-70">
        <DialogHeader>
        ...
        <DialogFooter className="w-full flex items-center">
          ...
          <Button form="search-form">{t("apply")}</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  )
